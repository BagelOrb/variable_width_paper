...
\centering
\includegraphics[width=.25\columnwidth]{sources/validation/visualization_principle_rounded_excluded_single.pdf}
\caption{
...
The prints which employ the uniform offsets technique clearly show a lot of underfill, which clearly impacts the visual performance of the print.
Moreover, in the case of the regular honeycomb there are several disconnected hexagons, while the whole part is supposed to be a single connected solid.
