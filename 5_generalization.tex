...
and
$t_0(n)$ the transition anchor position \jun{check whether this last one has been defined.}
and
...
\item $B$ is symmetric: $W(n, d)_i = W(n, d)_{n-i-1}$ and $L(n, d)_i = d - L(n, d)_{n-i-1}$
