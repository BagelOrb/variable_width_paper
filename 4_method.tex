...
\item Generate junctions along non-marked bones of the skeleton and connect the junctions together to form the toolpaths.
\end{enumerate}
...
Based on the feature radius $R$ there we place junctions along the insignificant bones following the beading strategy.
