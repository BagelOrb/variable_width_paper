...
The function $b$ is determined by the beading strategy.
...
$$
\left\{ b(d), W(n, d), L(n, d), t(n), t_0(n), \alpha_{\text{max}} \right\}
$$
where
...
$t_0(n)$ is the length of between the lower end and the anchor point of the transition from $n$ to $n+1$ beads
and
