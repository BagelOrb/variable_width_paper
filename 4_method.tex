...
Each of the trapezoids is connceting to a single outline polygon.
...
\begin{figure}
\centering
\includegraphics[width=.3\columnwidth]{sources/method/segment_generation.pdf}
\caption{
Generating toolpaths on a aprt of the test outline shape which is fully shown in \cref{shape_decomp_complex}.
