...
\caption{The radial distance can only increase along one edge around a branch point in the medial axis.}
...
If the upper node has the same bead count we mark all bones and nodes $v$ in between, and set the bead count $B^*_{v_0} = B^*_v = B^*_{v_1}$.
