...
\includegraphics[height=\figheight]{sources/method/trapezoid_beading_interpolation_beading.pdf}
\caption{Example beadings}\label{example_beading}
\end{subfigure}
\begin{subfigure}{0.4\columnwidth}\centering
\includegraphics[height=\figheight]{sources/method/trapezoid_beading_interpolation.pdf}
