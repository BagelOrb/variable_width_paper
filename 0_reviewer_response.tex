...
\commits{66d006d91d406c0064ee1f4f1e4df85fc0821994 e806d40e5e6d2bbe450c6792b802f0fcce4df645 86c5aa8fab91e326e658f79a0746462fb99ea2b0}
\paper{Intro}{
 \begin{itemize}
...
\paper{Conclusion}{
In this paper we have introduced a framework for computing contour-parallel toolpaths employing adaptive bead width in order to minimize underfill and overfill areas\revise{.}{ and we introduced beading schemes which improve on the state-of-the-art.}

[\dots]

\revise{We presented the}{The} inward distributed beading scheme
...
\commits{
5356492b5a9a690228ffdb6a6a26cf10d099a7d4
98af7981a67e9d54b3c47db5a2a41035e1278aeb % lil edit to the above
}
\paper{Method overview}{
Our method starts with computing \revise{the}{a type of} skeleton \revise{}{(a graph representing the topology) }of the input polygon based on the medial axis transform (MAT), a strategy that has been commonly used for generating contour-parallel toolpaths~\cite{eiamsa2003toward}. 
}
...
add to related work? Tim doesn't feel this belongs there because the whole related work section is on toolpath generation.
Adaptive offset techniques are only related to the technical contribution of this paper, so they don't belong in the related work section.
However, when discussing the union of cones there is no logical place to discuss
}
...
We have developed a new method for actualizing adaptive width control which can readily be applied to unmodified FDM systems such as the Ultimaker S5: linear back pressure compensation.
We show the results of linear back pressure compensation in a separate figure which clearly shows the achieved variance in bead width.
...
22cb3664ddc722d25e0a73df905100410f8ebf10 444a00a54100e402024335b79265b6900017bc1d % S5 prints
...
92217c04e118dcf6f65b16a1ffcdfa40b4d50c0d
2f230ea9f26f9870027e80db89eae8774f19d339
...
\todo{
discuss visual quality of S5 prints in the paper.
}
...
\commits{
3b13960e15c07f484ab641a2d941f6086eda571c dd293c060baae147ad1a217cf6ab68d8c4cb00c8
}
\paper{Conclusion}{
...
\todo{
disconnected toolpaths

single point tool paths

still under-/overfill in non-significant regions
}
