...
We have now introduced a new parameter in the widening meta-scheme which can be used specificly to tune the minimal diameter starting from which we generate a toolpath.
...
\Ans{
The bead width in \citeauthor{Jin2017JMS} is limited to $0.5 w^*$ to $1.8 w^*$ , which means the variation is a factor of $3.6$;
