...
e806d40e5e6d2bbe450c6792b802f0fcce4df645 % hightlight contributions
...
Because this algorithm is suboptimal, we separate the printing time into extrusion time and travel time.
These (new) results shed light on how much more travel time is required relatively.
...
\Ans{
The limitations are now handled in section 5.3 Theoretical considerations, together with an analysis of the relation between feature size and bead width range.
...
ecf99f47dadf9973f527c1d471d662d87f6a5f51 % Limitations
}
