...
where $w_\text{min}$ is a configarable parameter when using the widening meta-scheme.
}
}
...
{
\revise{}{A too large $\alpha_\text{max}$ leaves a lot of under-/overfill, while a too small value will introduce toolpaths to fill in negligibly small underfills.
