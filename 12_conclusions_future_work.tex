...
It reduces the amount of beads with a width deviating extremely from the nominal bead width, and thus it is expected to limit the impact of adaptive bead width on mechanical properties of the resulting print.
