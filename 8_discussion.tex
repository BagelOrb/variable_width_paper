...
For an input outline shape which contains both very small and very large features, the algorithm \jun{which specific scheme, or our method in general?} produces bead widths which can fall outside of the range of manufacturable bead widths.
...
the centered beading scheme effectively deals with both overfill and underfill and produces desired bead widths in all locations, except in the center the bead widths are within a factor 2 off from the desired bead width.
