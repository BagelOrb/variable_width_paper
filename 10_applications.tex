...
Gears and similar mechanical parts could benefit from the prevention of under- and overfill regions and the distributed bead widths because the more homogeneous extrusion widths cause the part to more closely 
conform to the presumed homogenized material properties of FDM products.
...
An angled Gyroid structure with uniform thickness also results in outline shapes with varying width (\cref{applications_gyroid}), which are accurately densely filled using our framework.
