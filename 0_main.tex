...
Some existing approaches address this issue by making local alterations to the toolpaths locations and widths in the center of the part.
...
Furthermore, we propose a novel scheme which distributes the alterations over an area large enough to avoid extremal bead width values, while limiting the number of altered toolpaths.
