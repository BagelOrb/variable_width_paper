...
the heights at central ridges in the 3D surface are flattened to be parallel with the slicing planes in order to prevent over- and underfill
...
We show that our open source implementation exhibits computation times in the same order of magnitude as the naive method.
\end{abstract}
