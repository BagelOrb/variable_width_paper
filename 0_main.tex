...
\title{A framework for adaptive width control of dense contour-parallel toolpaths in \revise{additive manufacturing}{fused deposition modeling}\censornotice}
...
\author[cuhk]{\censor{Charlie C. L. Wang}}
...
Furthermore, we propose a novel scheme\revise{ for FDM printing} which \revise{avoids}{reduces} extreme bead width deviation\revise{ from the nozzle size}{}, \revise{and limits}{while limiting} the number of altered toolpaths.
