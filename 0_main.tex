...
\begin{abstract}
3D printing techniques such as Fused Deposition Modeling (FDM) works by depositing material along paths which lie in horizontal layers.
...
Especially thin parts require an accurate dense filling, such as casings for electronics, blowmolding prototypes, (architectural) models and some tpyes of microstructure.
...
However, such methods inevitably generate extrusion toolpaths with widths wildly differing from the nozzle size.
