...
\title{A parametric system for contour parallel variable width toolpath generation}
...
\begin{abstract}
Additive manufacturing has enabled the fabrication of complex geometry quickly and cheaply.
3D printing techniques such as Fused Deposition Modeling (FDM) work by depositing material along paths which lie in horizontal layers.
