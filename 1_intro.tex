...
In this paper we propose a framework for planning toolpaths with control over the adaptive width \revise{for}{while} minimizing over- and underfill. 
...
\revise{}{furthermore} reduces the amount of deviation in the extrusion widths compared to \revise{existing literature, }{the state-of-the-art to be generally below a factor of 2.}
