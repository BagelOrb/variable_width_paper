...
Still, controlling the extrusion width through speed changes or through volumetric flow control (e.g. linear advance) yields diminishing accuracy for deposition widths farther away from the nozzle size, which influences mechanical and surface properties of the part~\cite{N.Turner2014,ahn2002anisotropic}.
