...
The current state-of-the-art for FDM printing developed by \citeauthor{Jin2017JMS} employs a strategy which alters the widths of the centermost beads \revise{at most by a factor of $2$}{within a range of widths with a factor of $3.6$}~\cite{Jin2017JMS},
...
\revise{}{furthermore} reduces the amount of deviation in the extrusion widths compared to \revise{existing literature, }{the state-of-the-art to be below a factor of 2.}
