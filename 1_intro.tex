...
This paper focusses on the contour-parallel toolpaths and addresses several issues which commonly occur in 3D models with geometry which is narrower than the typical number of perimeters.
}
