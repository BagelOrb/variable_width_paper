...
\citeauthor{Jin2017a} proposed the use of a sparse wavy path pattern for thin-walled parts~\cite{Jin2017a}.
...
This is due to the fact that the diameter of the part is not exact multiple of the (cosntant) deposition width in those regions.
...
In this paper we propose a novel scheme to distribute the width alterations throughout a region around the center, and thus limit the occurence of extreme deviations in width (see \cref{intro_wedge_distributed}).
