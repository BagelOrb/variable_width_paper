...
Reducing under- and over-filling can be accurately achieved by making use over adaptive \revise{depisition}{deposition} width.
...
The resulting variation of width in the center is still up to a factor of \revise{$2$}{$3.6$} (see \cref{intro_wedge_centered}).
