...
\citeauthor{Jin2017JMS} proposed to add a toolpath with varying width along the skeleton, while leaving other paths unchanged.
The variation of width in the central is pronounced (\cref{intro_wedge} middle).
