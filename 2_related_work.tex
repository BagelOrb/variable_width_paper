...
\todo{Tim: connecting the contour parallel lines is also exactly what the Fermat spiral papers are about.}
...
In this paper we propose an adaptive beading strategy to address this problem. Skeleton was also used in~\cite{Jin2017} to 

\todo{TODO: Describe the paper by } \citeauthor{Jin2017}
